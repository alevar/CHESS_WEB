        ...
        <div className="d-flex align-items-center gap-3 flex-wrap">
          ...
          {comparisonMode && secondaryData && (
            <div className="ms-auto">
              <span className="badge me-2 px-2 py-1" style={{ backgroundColor: primaryColor, color: 'white' }}>
                {primaryLabel}
              </span>
              <span className="badge px-2 py-1" style={{ backgroundColor: secondaryColor, color: 'white' }}>
                {secondaryLabel}
              </span>
            </div>
          )}
