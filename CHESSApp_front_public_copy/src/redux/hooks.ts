...
// Secondary transcript data hooks
export const useSecondaryTranscript = () => {
  return useAppSelector((state: RootState) => state.transcript.secondaryTranscript);
};

export const useSecondaryTranscriptLoading = () => {
  return useAppSelector((state: RootState) => state.transcript.secondaryLoading);
};

export const useSecondaryTranscriptError = () => {
  return useAppSelector((state: RootState) => state.transcript.secondaryError);
};