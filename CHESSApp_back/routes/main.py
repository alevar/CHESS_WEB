...
#        - transcript: transcript counts
#        - gene: gene counts
@main.route('/globalData', methods=['GET'])
def globalData():
...
@main.route('/txSummarySlice',methods=['POST'])
def txSummarySlice():
...
@main.route('/fetchData', methods=['POST'])
def fetch_data():
    settings = request.get_json()
...
@main.route('/getAttrCountsBySeqid', methods=['POST'])
...
@main.route('/getLociSummary', methods=['POST'])
def getLociSummary():
    settings = request.get_json()
...
@main.route('/findLoci', methods=['POST'])
def findLoci():
    settings = request.get_json()
...
@main.route('/getLocus', methods=['POST'])
def getLocus():
